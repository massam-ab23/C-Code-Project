...
Description:
This project implements a simple console-based banking system in C++.
It supports account creation, balance enquiry, deposits, withdrawals,
account closure, and persistent storage using file handling.
